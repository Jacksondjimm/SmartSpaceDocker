...
namespace RazorPagesApp.Pages
{
    ...
    {
        private readonly ILogger<hallwayModel> _logger;
        ...
        public hallwayModel(ILogger<hallwayModel> logger, IHttpClientFactory httpClientFactory) // дальнейшее дублирование конструктора IndexModel не приведёт к ошибке?
        {
            _logger = logger;
        ...
        public async Task OnGet()
        {
            ...
            var allData = await client.GetFromJsonAsync<List<Sensor_04>>("api/Hallway/GetAll")
                          ?? new List<Sensor_04>();
            ...
            // 3. Сортирем, пропускаем предыдущие страницы и берем нужное количество записей
            SensorData_04 = allData
