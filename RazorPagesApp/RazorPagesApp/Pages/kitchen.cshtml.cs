...
namespace RazorPagesApp.Pages
{
    public class kitchenModel : PageModel
    {
        ...
        public kitchenModel(ILogger<kitchenModel> logger, IHttpClientFactory httpClientFactory) // дальнейшее дублирование конструктора IndexModel не приведёт к ошибке?
        {
            _logger = logger;
        ...
        public async Task OnGet()
        {
            ...
            var allData = await client.GetFromJsonAsync<List<Sensor_05>>("api/Kitchen/GetAll")
                          ?? new List<Sensor_05>();
